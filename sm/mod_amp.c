...
static mod_ret_t _amp_pkt_user(mod_instance_t *mi, user_t *user, pkt_t *pkt) {
    mod_amp_config_t *config = mi->mod->private;
    int ns, elem, attr;
